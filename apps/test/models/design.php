...
class design extends model
{
  ...
  public $info;
	...
	public function get_all() {
		...
		$arr = $this->db->query("select designs.name, designs.rarity, designs.icon,
	        displayname.string as displayname
	        from designs
	        left join strings as displayname on displayname.stringid = designs.displaynameid")->results();
    ...
    $arr = $this->db->query("select designs.name, designs.rarity, designs.icon,
        ...
        where designs.outputtype = '{$type}'")->results();
