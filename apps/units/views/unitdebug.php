...
<div class="unit">
	...
	<div class="unitheader">
		<div class="unitrealname"><?=$typestring?></div>
		<div class="rarity"><span class="age"><?=$agestring?></span></div>
	</div>
	<br />
	<br />
	<div class="nameandpic">
		<img class="pic" src="/images/Art/<?=$data['Icon']?>.png" width="64px"/> <span class="name"><?=$data['DisplayName']?></span>
	</div>
